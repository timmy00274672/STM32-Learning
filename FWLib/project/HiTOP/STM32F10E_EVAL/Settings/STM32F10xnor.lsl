// define rom size
#define __ROM_SIZE               8192k
#define __ROM_ADDR               0x64000000
// define ram size
...
#define _Vectors                 0x64000000

#define _ENTRYADDR               (0x64000001 + __VECTOR_TABLE_SIZE + 80) /* xB0 */ 

#define _START                   max(_ENTRYADDR, 0x64000165)

#define __RESET                  0x64000004
